...
function Employ() {
    const paperStyle={padding:20,height:'65vh',width:450,margin:"20px auto"}
      ...
      <Paper className="paper" elevation={10} style={paperStyle}>
          <Grid>
              <div className="container">
                  <Grid>
                      <TextField label='Official Email id' placeholder="name@company_name.com" fullWidth required></TextField>
                      ...
                      <TextField label='Mobile Number' sx={{mt:2}} placeholder="+ 91" type="number" fullWidth required></TextField>
                  ...
                  <Button type="submit" color="primary" variant="contained" style={btstyle} fullWidth>Register Now</Button>
